# Hi, I'm Kolawole Afolabi Fakeye 👋

### Analytics Engineer | Backend & DevOps Specialist | Lekki, Lagos, Nigeria 🇳🇬

Seasoned Systems Engineer with **15+ years** managing enterprise infrastructure and high-availability systems. Now focused on building **reliable, observable, and automated** data applications using FastAPI, Python, and modern DevOps practices.
...
![Apache Parquet](https://img.shields.io/badge/Apache_Parquet-%23E25A1C.svg?style=for-the-badge&logo=apache&logoColor=white)
...
## ⚙️ DevOps & Systems Mindset

- **Infrastructure Foundation**: 15+ years in systems administration, server management, and high-availability operations.
- **Containerization & Deployment**: Actively integrating Docker for consistent environments.
- **Observability**: Building applications with telemetry, health monitoring, and structured logging.
- **Automation**: Strong focus on pipelines, version control (Git), and reliable software delivery practices.

---

## 💡 About Me

Passionate about bridging traditional systems engineering with modern backend and DevOps practices. Always focused on building systems that are **reliable, scalable, and observable**.
...
- **💼 LinkedIn:** [Kolawole Fakeye](https://www.linkedin.com/in/kolawolefakeye/)
- **🐙 GitHub:** [Explore Repositories](https://github.com/Kolawole-Fakeye)
- **📧 Email:** kolawole.afolabi.fakeye@gmail.com

---

*Building reliable systems. Always learning.*
